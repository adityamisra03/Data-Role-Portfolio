...
fchl = geo.get_GEO(filepath="data_hypergeometric_enrichment_analysis/GSE17170_family.soft")
...
df_USF1_OE_DEGs = pd.read_csv('data_hypergeometric_enrichment_analysis/df_USF1_OE_DEGs.csv', header=0, index_col=0) 
...
df_USF_M00122_target_genes = pd.read_csv('data_hypergeometric_enrichment_analysis/V_USF_02_M00122_genes.tsv', delimiter='\t', index_col=0, header=0)
...
df_rs3737787_corr = pd.read_csv('data_hypergeometric_enrichment_analysis/df_rs3737787_corr.csv', header=0, index_col=0)
...
df_FCHL_DEGs = pd.read_csv('data_hypergeometric_enrichment_analysis/df_FCHL_DEGs.csv', header=0, index_col=0)
...
module_membership = pd.read_csv('data_hypergeometric_enrichment_analysis/moduleMembership_Plaisier2009.csv',header=0, index_col=0)
